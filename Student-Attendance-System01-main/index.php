...
<head>
    ...
    <title>SJC LAB ATTENDANCE - Login</title>
...
<body class="bg-gradient-login" style="background-image: url('sjc.jpeg');">
    <!-- Login Content -->
                            ...
                            <div class="col-lg-12">
                                <div class="login-form">
                                    ...
                                    <div class="text-center">
                                        <img src="img/logo/download.jpg" style="width:100px;height:100px">
                                        <br><br>
