...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    value('$firstName','$lastName','$intial','$admissionNumber','12345','$classId','$classArmId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName',
    otherName='$initial', admissionNumber='$admissionNumber',password='12345', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
            if ($query) {
